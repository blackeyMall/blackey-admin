  ...
  <div class="mod-user">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('flowers:referee:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
      </el-form-item>
    </el-form>
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" :fit="true">
      ...
      <el-table-column prop="name" header-align="center" align="center" label="推荐人姓名">
      </el-table-column>
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          ...
          <el-button v-if="isAuth('flowers:referee:delete')" type="text" size="small" @click="deleteHandle(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import AddOrUpdate from "./referee-add-or-update";
export default {
  data() {
    return {
      dataForm: {
  ...
  methods: {
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        ...
        .then(() => {
          this.$http({
            url: this.$http.adornUrl(`/flowers/referee/delete/${id}`),
            method: "get",
