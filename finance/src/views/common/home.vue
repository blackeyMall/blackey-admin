<template>
  <div class="mod-home">
    <h3>欢迎使用稻股论坛后台管理平台`</h3>
    <!-- <ul>
      <li>blackey-admin-vue基于vue、element-ui构建开发，实现<a href="https://gitee.com/renrenio/renren-fast" target="_blank">renren-fast</a>后台管理前端功能，提供一套更优的前端解决方案</li>
    ...
    <ul>
      ...
      <li>前端Git地址：<a href="//github.com/daxiongYang/blackey-admin-vue" target="_blank">github.com/daxiongYang/blackey-admin-vue</a></li>
