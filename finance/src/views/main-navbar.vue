  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">稻股论坛管理平台</a>
        <a class="site-navbar__brand-mini" href="javascript:;">DaoGu</a>
      </h1>
    </div>
    <div class="site-navbar__body clearfix">
      ...
      <el-menu class="site-navbar__menu site-navbar__menu--right" mode="horizontal">
        ...
        <el-submenu index="3">
          ...
          <el-menu-item index="2-1"><a href="//github.com/daxiongYang/blackey-admin-vue" target="_blank">前端</a></el-menu-item>
